...
"좋은 하네스"의 기준은 고정되어 있지 않습니다. 업계 best practice가 바뀌면 기준도 함께 바뀌어야 합니다.

Harness Coach는 매주 수요일 자동으로 **진화 레이어(Evolution Layer)** 를 업데이트합니다.
...
매주 월요일 최적화 루프가 돌 때는 **그 주까지 업데이트된 이상향 기준**으로 진단합니다. 하네스의 기준 자체가 업계와 함께 성장하는 구조입니다.
